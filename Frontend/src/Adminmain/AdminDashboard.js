        ...
        <div className="container">
            ...
            {adminData && bloodBankData &&
                <div>
                    ...
                    <p>Name: {bloodBankData.bloodbank_name}</p>
                    <p>Group: {bloodBankData.bloodbank_group}</p>
                </div>
            }
        </div>
            ...
            <tr key={Patient.patient_id}>
              ...
              {/* <td>
                     ...
                     <button className='user_edit_button'>Edit</button>
                      ...
                      <button onClick={() => handleDelete(Patient.patient_id)} className='user_delete_button'>Delete</button>
                    </td> */}
            </tr>
          ))}
        </tbody>
